...
<div class="container mt-4">
    ...
    @endif
    <form action="/cap-nhat-user" method="post">
        @csrf
        <table class="table table-bordered">
            <tr class="table-info" >
                <td>mã nhân viên</td>
                <td>
                    <input type="text" class="form-control" value="{{ $users[0]->user_id }}" name="txt_user_id" hidden>
                    <input type="text" class="form-control" value="{{ $users[0]->HoTenNV }}" name="txt_manv" readonly>
            ...
            <tr class="table-info" >
                <td>Tên Nhân Viên</td>
                <td>
                    <input type="text" class="form-control" value="{{ $users[0]->taikhoan }}" name="txt_taikhoan" readonly>
            ...
            <tr class="table-info" >
                <td>mật khẩu</td>
                <td>
                    <input type="password" class="form-control" value="{{ $users[0]->matkhau }}" name="txt_matkhau" >
